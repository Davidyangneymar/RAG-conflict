"""
P6-facing controlled-generation planning contracts.

This layer consumes P2 conflict-typed outputs and builds:
  1) answer context (query + clustered evidence + conflict summary)
  2) two-stage prompts (analysis draft -> constrained final answer)
  3) abstention decision metadata
"""
